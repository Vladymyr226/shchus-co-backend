...
const subscriptionHandler = async (req: Request, res: Response) => {
  ...
  const orderBody = {
    ...
    amount: 80000,
    currency: 'UAH',
    response_url: 'https://shchus-co-backend.herokuapp.com/api-co/payment/redirect',
    server_callback_url: 'https://shchus-co-backend.herokuapp.com/api-co/payment/save',
