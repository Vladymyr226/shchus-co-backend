exports.up = async function (knex) {
  return knex.schema.createTable('constructor_designer_items', function (table) {
    table.increments('id').primary()
    table.integer('constructor_designer_id').references('constructor_designer.id').notNullable()
...
exports.down = async function (knex) {
  return knex.schema.dropTable('constructor_designer_items')
}
