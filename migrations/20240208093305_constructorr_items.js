exports.up = async function (knex) {
  return knex.schema.createTable('constructorr_items', function (table) {
    table.increments('id').primary()
    table.integer('constructorr_id').references('constructorr.id').notNullable()
...
exports.down = async function (knex) {
  return knex.schema.dropTable('constructorr_items')
}
